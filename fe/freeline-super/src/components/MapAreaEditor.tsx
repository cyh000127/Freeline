          ...
          {areas.map((area, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-1 left-1 bg-white/90 shadow-sm px-2 py-1 flex flex-col gap-1 rounded text-xs truncate max-w-[90%] font-bold text-gray-800" onPointerDown={e => e.stopPropagation()}>
                  {isEditMode ? (
                    <select 
