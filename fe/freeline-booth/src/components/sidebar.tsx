    ...
    <div className="flex w-[240px] flex-col bg-[#2D2A4A] text-white">
      ...
      <div className="p-4">
          ...
          <div className="mt-6 flex flex-col border-t border-white/10 pt-6">
              <div
                  className="rounded-2xl bg-white/5 p-5 border border-white/5 shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                      <div
                          className="h-6 w-6 flex items-center justify-center rounded-full bg-lime-400 text-[#2D2A4A] text-[12px] font-black">
                          B
                      </div>
